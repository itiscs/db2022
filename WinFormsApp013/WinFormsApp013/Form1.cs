...
namespace WinFormsApp013
{
    public partial class Form1 : Form
    {
        ...
        private void àëüòåðíàòèâíàÿÔîðìàToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form2 f2 = new Form2();
            f2.ShowDialog();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Èçìåíåíèÿ ñîõðàíåíû!");
            }
            catch(Exception ex) 
            {
        ...
        private void oRMÔîðìàToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OrmForm f = new OrmForm();
            f.ShowDialog();
        }

        private void çàäà÷à1ToolStripMenuItem_Click(object sender, EventArgs e)
        {
